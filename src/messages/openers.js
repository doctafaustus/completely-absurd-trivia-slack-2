module.exports = [
  'asserts the Coronavirus is the Democrats\' "new hoax"',
  'has worn the same pair of sweatpants since Tuesday',
  'really misses other people',
  'was caught hoarding crucial PPE from frontline healthcare workers',
  ...
  'has accepted your Instagram pushup challenge', 
  'maintains six feet of distance in public spaces', 
  'has been predicting a global pandemic for years',
  'has been 3d printing face masks', 
  'could really use a haircut', 
  'is doing their part in flattening the curve',
  'claims they have the sole authority to reopen the country, not governors',
  'is a regular at Zoom happy hours', 
  'really loves the anxiety from this whole thing', 
  'was caught on a Spring Break trip in Florida',
  'is negotiating oil prices with Russia and Saudi Arabia',
  'claims Accenture is an essential business that should remain open',
  'washes their hands regularly for 20 seconds',
  'beat children at a spelling bee by correctly spelling the word "hydroxychloroquine"',
  'is tweeting about their TV ratings', 
  'is founder of the Official Dr. Fauci Fan Club', 
  'is predicting this recession to be the worst economic downturn since the Great Depression', 
  'has been quoted as vocally critical of the World Health Organization',
  'considers digital optimization to be an essential business',
  'is spending their $1200 stimulus check on sneakers',
  'somehow isn\'t stressed by the 24 hour news cycle',
  'has been ordering online from Jo\'s Coffee',
  'can coherently explain an R0 value',
  'has been accused of politicizing the pandemic',
  'thinks the news media has been awfully unfair',
  'really misses 2-Day Shipping',
  'has been extending loans to small businesses',
  'can\'t believe the wait at Costco',
  'was one of the Clearheaders seen in the office on Monday, March 16',
  'finds Microsoft Teams to be surprisingly user friendly', 
  'is feeling a little stircrazy', 
  'is the proud owner of a "Weird Homes Tour" gift certificate', 
  'has been trolled by Brendan via Skype',
  'has been surviving on chips stolen from the office',
  'has been sequencing the COVID-19 genome on their nights and weekends',
  'regularly wipes down surfaces',
  'has built their last COVID-19 modal', 
  'was warned of the virus back in January and did nothing',
  'is asking to borrow your Netflix password',
  'has taken a new interest in sewing masks for family and friends',
